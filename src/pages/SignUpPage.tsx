  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-surface">
            ...
            {step === 1 ? (
              <div className="text-center w-full">
                ...
                <p className="text-sm font-body text-neutral-600 mt-3 max-w-md mx-auto leading-relaxed">
                  Empowering Nigeria's educational leaders through professional excellence.
                </p>
              </div>
            ) : (
      ...
      <div className="w-full flex items-center justify-center gap-8 py-4 bg-surface-card border-y border-neutral-200 text-[11px] font-600 font-body text-neutral-500">
        <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-[14px]">verified</span> TRCN Accredited</span>
        <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-[14px]">lock</span> Secure Data</span>
      </div>
      ...
      <footer className="w-full max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-xs font-body text-neutral-600 bg-surface">
        <div className="space-y-2">
          <h4 className="font-headline font-800 text-base text-tertiary-500">SLAN Online</h4>
          <p className="text-neutral-500 leading-relaxed">
            © {currentYear} School Leadership Academy Nigeria (SLAN). Accredited by TRCN & ANCOPPS. Elevating education through leadership mastery.
          </p>
        </div>
        <div className="flex flex-col gap-2 md:items-center">
          <div className="text-left space-y-2">
            <h5 className="font-700 text-tertiary-500 uppercase tracking-wider text-[11px]">Resources</h5>
            <a href="#privacy" className="block hover:text-primary-500 transition-colors">Privacy Policy</a>
            <a href="#terms" className="block hover:text-primary-500 transition-colors">Terms of Service</a>
          </div>
        </div>
        <div className="flex flex-col gap-2 md:items-end">
          <div className="text-left space-y-2 w-full max-w-[160px]">
            <h5 className="font-700 text-tertiary-500 uppercase tracking-wider text-[11px]">Help & Support</h5>
            <a href="#accreditation" className="block hover:text-primary-500 transition-colors">Accreditation</a>
            <a href="#support" className="block hover:text-primary-500 transition-colors">Support Contact</a>
          </div>
        </div>
      </footer>
    </div>
